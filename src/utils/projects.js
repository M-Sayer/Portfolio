...
const projects = [
  {
    ...
    readMore: <>
      ...
      <p>i built this project primarily over two weeks, spending a good amount each day, and then during a subsequent week, i polished up some features and added some basic design. mostly with this project i wanted to practice more technical skills across the full stack, although i hope to go in and add more in depth CSS at some point.</p>
